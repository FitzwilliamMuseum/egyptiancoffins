...
To minimise the effect of warping on the overall structure, the carpenters of the coffin box ensured that the heartwood was a different way up on each adjacent plank, as shown in a single CT image (transverse) through the box![image](https://)
